...
import { BlockTemplate, Layer } from "@/types/editor/editorTypes";
  ...
  return getTemplateRef("slide", {
    ...
    design: {
      ...
      backgrounds: {
        ...
        bgImageVars: { "--bg-img": `url(${imageUrl})` },
      },
    },
    variables: {
      backgroundImage: {
        src: { type: "dynamic_text", data: { content: imageUrl } },
      },
    },
    children: [
      {
      ...
      },
      {
        ...
        design: {
          ...
          positioning: { isActive: true, position: "static" },
        },
        restrictions: { editText: true },
        variables: {
          text: {
            ...
            data: {
              content: {
                ...
                content: [
                  {
                    type: "paragraph",
                    content: [{ type: "text", text: "Add your slogan here" }],
                  },
                ],
              },
            },
...
export function createSlideLayer(
  title: string,
  imageUrl: string,
): Layer | null {
    ...
    template: {
      ...
      design: {
        ...
        backgrounds: {
          ...
          backgroundImage: "--bg-img",
          bgImageVars: {
            "--bg-img": "url(/ycode/layouts/assets/placeholder-2.webp)",
          },
        },
      },
      ...
      variables: {
        backgroundImage: {
          src: {
            type: "dynamic_text",
            data: { content: "/ycode/layouts/assets/placeholder-2.webp" },
          },
        },
      },
      children: [
            ...
            getTemplateRef("icon", {
              ...
              variables: {
                icon: {
                  src: {
                    type: "static_text",
                    data: { content: CHEVRON_RIGHT_SVG },
                  },
                },
              },
              classes: ["w-[24px]", "h-[24px]", "text-white"],
      ...
      children: [
        // Slides wrapper with 3 default slides
        {
          ...
          children: [
            createSlideRef(
              "Slide 1",
              "/ycode/layouts/assets/placeholder-2.webp",
            ),
            createSlideRef(
              "Slide 2",
              "/ycode/layouts/assets/placeholder-3.webp",
            ),
            createSlideRef(
              "Slide 3",
              "/ycode/layouts/assets/placeholder-7.webp",
            ),
          ],
        },
        ...
        getTemplateRef("slidePaginationWrapper", {
          ...
          children: [
            getTemplateRef("slideBullets", {
              children: [getTemplateRef("slideBullet")],
            }),
          ...
          variables: {
            icon: {
              src: {
                ...
                data: {
                  content:
                    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 0 1 1.06.02L10 11.168l3.71-3.938a.75.75 0 1 1 1.08 1.04l-4.25 4.5a.75.75 0 0 1-1.08 0l-4.25-4.5a.75.75 0 0 1 .02-1.06Z" clip-rule="evenodd"></path></svg>',
                },
              },
            },
          },
